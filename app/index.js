  ...
  function chartTrend(){
    ...
    var chartTrend = c3.generate({
          ...
          data: {
          		x: 'x',
                columns: [
                	['x',1993,1997,2001,2005,2009,2013],
                  ['Minneapolis',0.45,0.46,0.41,0.30,0.20,0.33],
                  ['St. Paul',0.43,0.43,0.41,0.36,0.22,0.20]
                ],
            type: 'line',
            labels: {
                format: {
          ...
          grid: {
              x: {
              lines: [
                    {value: 2009, text: 'Rank choice introduced', position: 'end', class:'powerline'}
              ]
              }
          }
    ...
    var chartReg = c3.generate({
          ...
          data: {
              x: 'x',
                columns: [
                  ['x',1993,1997,2001,2005,2009,2013],
                  ['Minneapolis',222101,200311,217802,229593,231078,233351],
                  ['St. Paul',143878,138198,144213,160414,157859,154672]
                ],
            type: 'bar',
            labels: {
                format: {
  ...
  function chartMPLS(){
    ...
    var chartMPLS = c3.generate({
          ...
          data: {
                ...
                columns: [
                	['x',1993,1997,2001,2005,2009,2013],
                    ["Ward 1",0.51,0.48,0.41,0.31,0.23,0.3],
          					["Ward 2",0.3,0.29,0.27,0.26,0.14,0.27],
          					["Ward 3",0.42,0.41,0.35,0.22,0.14,0.31],
          					["Ward 4",0.49,0.47,0.39,0.24,0.21,0.23],
          					["Ward 5",0.37,0.4,0.37,0.24,0.17,0.24],
          					["Ward 6",0.32,0.35,0.26,0.21,0.14,0.34],
          					["Ward 7",0.44,0.46,0.39,0.28,0.19,0.34],
          					["Ward 8",0.47,0.45,0.41,0.35,0.2,0.35],
          					["Ward 9",0.48,0.49,0.43,0.32,0.21,0.34],
          					["Ward 10",0.4,0.45,0.37,0.28,0.18,0.3],
          					["Ward 11",0.54,0.54,0.5,0.35,0.21,0.39],
          					["Ward 12",0.53,0.54,0.49,0.38,0.23,0.4],
          					["Ward 13",0.56,0.6,0.51,0.41,0.27,0.46]
                ],
            type: 'line',
            labels: {
                format: {
  ...
  function chartSTP(){
    ...
    var chartSTP = c3.generate({
          ...
          data: {
                ...
                columns: [
                	['x',1993,1997,2001,2005,2009,2013],
                  ["Ward 1",0.40,0.37,0.33,0.31,0.18,0.24],
                  ["Ward 2",0.44,0.43,0.34,0.38,0.22,0.20],
                  ["Ward 3",0.53,0.52,0.34,0.49,0.31,0.26],
                  ["Ward 4",0.46,0.43,0.32,0.41,0.24,0.22],
                  ["Ward 5",0.39,0.43,0.33,0.32,0.18,0.16],
                  ["Ward 6",0.40,0.41,0.36,0.31,0.17,0.14],
                  ["Ward 7",0.38,0.47,0.35,0.31,0.16,0.14]
                ],
            type: 'line',
            labels: {
                format: {
